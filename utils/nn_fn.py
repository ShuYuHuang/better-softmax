...
class ClasModel(nn.Module):
    def __init__(self,in_features,out_features=10,n_layers=3,latent_features=3,SoftMaxLayer=AddMarginProduct,s=30,m=0.2,mode="arc"):
        super().__init__()
        HIDDEN=64
        ...
        self.softmax=SoftMaxLayer(latent_features,out_features,s=s,m=m)
